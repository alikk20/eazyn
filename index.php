...
$query = "select izin.*, guru.nama as nama_guru, bk.nama as nama_bk from izin join guru on guru.id=izin.guru_id inner join bk on bk.id=izin.bk_id";
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="border-bottom-0">
                            ...
                            <span class="fw-semibold mb-1"></span>                          
                        </td>
                        <td class="border-bottom-0">
                  ...
                  <div class="card-body p-4">
                    ...
                    <div class="row align-items-center">
                      <div class="col-2">
                        ...
                        $query2 = "select count(id) as jumlah_izin from izin where is_approved = 2 and siswa_id = 2";

                        $run_sql1 = mysqli_query($is_connect, $query1);
                        $run_sql2 = mysqli_query($is_connect, $query2);

                        $fetch_data1 = mysqli_fetch_all($run_sql1, MYSQLI_ASSOC);
                        $fetch_data2 = mysqli_fetch_all($run_sql2, MYSQLI_ASSOC);
