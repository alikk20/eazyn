                  ...
                  <form>
                    <div class="mb-3">
                      ...
                      <select class="form-select" aria-label="Default select example" name="guru_id">
                          ...
                          <option value="2">Eka Nur</option>
                          <option value="3">Diyono</option>
                          <option value="4">Budiman</option>
                          <option value="5">Subarna</option>
                          <option value="6">Winarni</option>
                          <option value="7">Catarina</option>
                      </select>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputPassword1" class="form-label" name="alasan">Alasan</label>
                      <input type="email" class="form-tabel" id="exampleInputEmail1">
                    </div>
                    <div class="mb-3">
